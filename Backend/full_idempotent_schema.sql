...
IF NOT EXISTS (
    ...
    WHERE [MigrationId] = N'20260408121251_AddCTBaoGia'
)
BEGIN
    CREATE TABLE [COUPON] (
...
BEGIN
    EXEC(N'CREATE UNIQUE INDEX [IX_KHACHHANG_MaTaiKhoan] ON [KHACHHANG] ([MaTaiKhoan]) WHERE [MaTaiKhoan] IS NOT NULL');
END;
GO
...
BEGIN
    EXEC(N'CREATE UNIQUE INDEX [IX_NHANVIEN_MaTaiKhoan] ON [NHANVIEN] ([MaTaiKhoan]) WHERE [MaTaiKhoan] IS NOT NULL');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260409202517_AddBrandAndOrigin'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260409203751_AddCategoryImage'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260412090355_RemoveBaoCao'
)
BEGIN
    DROP TABLE [BAOCAO];
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260412091543_RemoveBaoGia'
)
BEGIN
    DROP TABLE [CTBAOGIA];
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260412092250_RemoveNoNhaCungCap'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260412184729_AddCustomerBirthday'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260413094555_AddKhachHangAnhDaiDien'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260413094952_AddCustomerIdentityFields'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260428102909_RestoreSupplierDebtsV2'
)
BEGIN
