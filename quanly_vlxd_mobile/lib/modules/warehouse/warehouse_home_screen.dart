          ...
          IconButton(
            ...
            onPressed: () {
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('Chức năng quét mã vạch đang được xây dựng')),
              );
            },
          ),
        ],
...
class _SuppliersWarehouseTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<Map<String, dynamic>> mockSuppliers = [
      {"name": "Công ty Cổ phần Xi măng Hà Tiên", "phone": "028.38123456", "category": "Xi măng", "address": "Quận 1, TP.HCM"},
      {"name": "Tập đoàn Thép Hòa Phát", "phone": "024.62848666", "category": "Thép xây dựng", "address": "Hưng Yên"},
      {"name": "Nhà máy Gạch Tuynel Bình Dương", "phone": "0274.3555666", "category": "Gạch ngói", "address": "Bình Dương"},
      {"name": "Mỏ đá Hóa An", "phone": "0251.3955777", "category": "Cát, Đá", "address": "Đồng Nai"},
    ];
      ...
      children: [
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text('Nhà cung ứng (${mockSuppliers.length})', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
              ElevatedButton.icon(
                onPressed: () {
                  ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Mở popup thêm nhà cung cấp mới')));
                },
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  leading: CircleAvatar(backgroundColor: Colors.orange.shade100, child: const Icon(Icons.business, color: Colors.orange)),
                  ...
                  subtitle: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 4),
                      Text('Địa chỉ: ${s['address']}', style: TextStyle(color: Colors.grey.shade700)),
                    ],
                  ),
                  trailing: const Icon(Icons.arrow_forward_ios, size: 16),
                  onTap: () {
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Xem hợp đồng & lịch sử nhập hàng từ ${s['name']}')));
                  },
                ),
              );
            },
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          CircleAvatar(radius: 48, backgroundColor: Colors.orange.shade200, child: const Icon(Icons.person, size: 48, color: Colors.orange)),
          const SizedBox(height: 16),
          const Text('Trang Cá Nhân Nhân Viên Kho', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20)),
          const Text('Vai trò: Nhân viên Kho (Warehouse)', style: TextStyle(color: Colors.grey)),
